...
# and then, we can use command-line tool
# for the command-line tool: see README.md/Command Line
# thereafter we can use this named architecture in command line
# that is to say : `--arch tutorial_simple_lstm`
...
'''
this is very slow, we can accelerate it by incremental decoder
see this : https://fairseq.readthedocs.io/en/latest/tutorial_simple_lstm.html
