...
ATTENTION : you should put this file in your /fairseq/models
we show it here only for show
'''

# @register_model('rnn_backbone')
class RNN(nn.Module):
...
# every registered model must implement the BaseFairseqModel interface
...
# thereafter, we can use --arch in command line.
